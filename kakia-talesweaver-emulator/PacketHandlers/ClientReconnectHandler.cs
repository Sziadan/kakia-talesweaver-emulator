...
[PacketHandlerAttr(PacketType.ClientReconnect)]
public class ClientReconnectHandler : PacketHandler
{
	public override void HandlePacket(IPlayerClient client, RawPacket p)
	{
		var seed = BinaryPrimitives.ReadUInt32BigEndian(p.Data.AsSpan().Slice(4, 4));
		client.UpdateCryptoSeed(seed);

		switch(client.GetServerType())
		{
			case Models.ServerType.Lobby:
				SendToCharacterSelect(client, p);
				break;

			case Models.ServerType.World:
				SendToWorld(client, p);
				break;

			default:
				Logger.Log("Client sent \"ClientReconnect\" packet logging in to LoginServer ??");
				break;
		}
	}
...
00 00 00 00 00 00 00 00 00 00 00 ".ToByteArray(), CancellationToken.None).Wait();
	...
	public void SendToCharacterSelect(IPlayerClient client, RawPacket p)
	{
		client.Send(MetaFile(), CancellationToken.None).Wait();
...
A1 6E 00 00 00 00 00 00 00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
...
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
0F A1 BA 00 00 00 00 00 00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
...
6D 61 69 6C 2E 63 6F 6D".ToByteArray(), CancellationToken.None).Wait();
	...
	/// <summary>
	/// Big packet that contain information about a lot of meta data files
	/// </summary>
	/// <returns></returns>
	public static byte[] MetaFile()
	{
		return @"18 00 01 00 D3 14 43 61 72 64 69 66 66 5F 57 65
...
70 2E 6D 65 74 61 8A 2B CC A9 10 45 6C 74 69 76
...
74 61 A9 11 B0 38 13 43 6C 75 62 5F 41 67 69 74
...
52 75 6E 65 5F 56 69 73 69 74 2E 6D 65 74 61 AA
94 A5 78 11 41 64 73 65 6C 6C 5F 4D 61 67 69 63
...
C8 06 0B 4E 50 43 47 65 6E 49 6E 66 6F 30 C3 F3
47 2B 0B 4E 50 43 47 65 6E 49 6E 66 6F 31 21 21
3F 22 0F 42 65 61 75 74 79 53 6B 69 6E 2E 6D 65
...
70 2E 6D 65 74 61 0C 33 40 2F 14 4E 6F 72 6D 61
...
6F 70 2E 6D 65 74 61 06 B0 2E FD 15 53 69 6C 76
...
19 98 22 78 15 42 6C 75 65 63 6F 72 61 6C 5F 57
...
2E 6D 65 74 61 D2 7D 25 28 12 52 75 6D 6F 6C 69
...
74 2E 6D 65 74 61 28 F2 90 69 17 53 68 61 64 6F
...
66 6F 30 A1 A5 C6 A3 10 53 61 6E 73 72 75 5F 46
69 73 68 2E 6D 65 74 61 9B 7F 42 05 0B 45 76 65
6E 74 73 2E 6D 65 74 61 A2 46 81 F8 0F 4D 6F 6E
73 74 65 72 47 65 6E 49 6E 66 6F 31 B8 1D 5F FB
...
74 61 5D 7F 4F 11 11 45 6C 74 69 76 6F 5F 4D 61
...
72 2E 6D 65 74 61 1C B5 53 ED 13 41 74 74 72 69
...
52 89 4D 5B 13 42 6C 61 63 6B 4F 6C 69 76 65 53
68 6F 70 2E 6D 65 74 61 32 D3 AF 99 12 4F 75 74
50 6F 73 74 5F 51 75 65 73 74 2E 6D 65 74 61 B5
